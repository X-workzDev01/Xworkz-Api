...
public interface FeesService {
	...
	String writeFeesDetiles(FeesUiDto dto) throws IOException, IllegalAccessException;
	...
	FeesDto updateFeesFollowUp(FeesDto dto, String feesDetiles, String range) throws IOException;
